...
const Home = () => {
  ...
  // Счётчики для блока sec-2
  const [refCount1, inViewCount1] = useInView({ triggerOnce: true });
  const [refCount2, inViewCount2] = useInView({ triggerOnce: true });
  ...
  return (
    <>
      <Helmet>
        <html lang="ru" />
        <title>
          YooApp – Платформа для доставки еды | Сайт и приложение под ключ
        </title>
        <meta
          name="description"
          content="Запустите собственный сервис доставки еды с YooApp. Мобильное приложение, сайт, QR-меню, система учета. Увеличьте прибыль на 30%. Попробуйте бесплатно."
        />
        <meta
          name="keywords"
          content="доставка еды, приложение для доставки, заказ еды, мобильное приложение для ресторана, сайт для доставки, система учета, разработка приложения доставки"
        />
        <meta
          property="og:title"
          content="YooApp – Платформа для доставки еды"
        />
        <meta
          property="og:description"
          content="Запустите собственный сервис доставки еды. Увеличьте прибыль на 30%."
        />
          ...
          {`
            {
              ...
              "@type": "Product",
              "name": "YooApp",
              "description": "Платформа для создания сайта и приложения доставки еды",
              "brand": {
                "@type": "Brand",
                "name": "YooApp"
              },
              ...
              <Row>
                <Col xs={12} md={10} lg={8} xl={6}>
                  <div className="d-flex align-items-center mb-4">
                    <img src="/images/tomato.svg" alt="Помидор YooApp" />
          ...
          <section className="sec-2 mb-6">
            <Container>
              <Row xs={1} md={3} className="g-3 g-lg-4">
                <Col>
                  <div className="pros-1" ref={refCount1}>
                    <h4>
                      {inViewCount1 ? (
                        <>
                          <CountUp end={43} suffix="%" duration={2} />{" "}
                          {t("увеличение заказов")} <br />
                          <CountUp end={52} suffix="%" duration={2} />{" "}
                          {t("рост выручки*")}
                        </>
                      ) : (
                        t(
                          "Увеличим количество заказов на 43% и выручку на 52%*",
                        )
                      )}
                    </h4>
                  </div>
              ...
              <Row className="g-2 g-xl-4">
                <Col xs={12} lg={5}>
                  <div className="grayBlock-1">
                    <h3 className="text-uppercase deepblue mb-2">
                      {t("старт")}
                    </h3>
            ...
            <Container>
              ...
              <picture>
                <img
                  ...
                  alt="Схема интеграции YooApp с системами учета iiko, r_keeper, Frontpad"
              ...
              <picture>
                <img
                  ...
                  alt="Схема интеграции для мобильных"
                  ...
                  <Row xs={1} md={2} className="flex-md-row-reverse g-4">
                    <Col>
                      <div className="textBox">
                        ...
                        />
                        <h3>
                          {t("Система лояльности есть, даже если её нет")}
                        </h3>
                        <p>
                          {t(
                ...
                <div className="info1">
                  ...
                  <ul className="list-unstyled row row-cols-3 g-2">
                    ...
                    <li>
                      <div className="logotip">
                        <img
                          src="/images/logotips/Yoomoney.svg"
                          alt="Yoomoney"
                        />
                      </div>
                    </li>
                        ...
                        <div>
                          ...
                          <ul>
                            ...
                            <li className="d-none justify-content-between d-lg-flex">
                              <span>
                                {t("Размещение ")} <br />в Google Play и App
                                Store
                              </span>
                              <span>{t("Бесплатно")}</span>
                            </li>
